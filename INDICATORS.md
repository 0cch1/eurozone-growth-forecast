...
| unemployment_rate | Eurostat | `une_rt_a` | Annual | Unemployment rate (% of active population, PC_ACT), euro area. **Excluded from modelling pipeline** (contemporaneous with GDP → data leakage risk); retained in raw panel for reference. |
