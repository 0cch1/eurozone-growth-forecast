...
You can customize sources in `src/data_loader.py`. Variable definitions, units, and raw file formats are in **[docs/data_dictionary.md](docs/data_dictionary.md)**.
